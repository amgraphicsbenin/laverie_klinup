        ...
        <AnimatePresence initial={false}>
          {state === "loading" ? (
            <IconSlot keyId="loading-icon">
              <Loader2 className="h-4 w-4 animate-spin" style={{ width: "1rem", height: "1rem", animation: "spin-laundry 1s linear infinite" }} />
            </IconSlot>
          ) : null}
          {state === "success" ? (
            <IconSlot keyId="success-icon">
              <Check className="h-4 w-4" style={{ width: "1rem", height: "1rem" }} />
            </IconSlot>
          ) : null}
          {state === "error" ? (
