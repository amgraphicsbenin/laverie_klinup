...
let memoryDb = {
  ...
  current_user: DEFAULT_STAFF[2] // Default to Pierre Diallo for the mobile app
};
...
function loadFromLocalStorage() {
  ...
  memoryDb.current_user = loadData(STORAGE_KEYS.CURRENT_USER, DEFAULT_STAFF[2]);
  db.notify();
}
