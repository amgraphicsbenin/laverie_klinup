/**
 * @file seeds.js
 * @description Données de test / démo pour l'application Mobile KLIN UP.
 * Contient le personnel d'origine (DEFAULT_STAFF) et le catalogue de services (DEFAULT_CATALOG).
 */
...
export const DEFAULT_CATALOG = [
  ...
  // Abonnements
  { id: 'sub1', article: 'Offre Active', service: 'abonnement', prix: 20000, description: '25 vêtements | Validité 30 jours | Livraison et ramassage gratuits', categorie: 'abonnement', nombre_vetements: 25, duree_jours: 30, ramassage: true, nombre_ramassages: null, ramassage_gratuit: true, livraison_gratuite: true, is_active: true, statut: 'actif' },
  { id: 'sub2', article: 'Abonnement Premium', service: 'abonnement', prix: 35000, description: '50 vêtements max | Validité 30 jours | 2 ramassages max | Ramassage et livraison gratuits', categorie: 'abonnement', nombre_vetements: 50, duree_jours: 30, ramassage: true, nombre_ramassages: 2, ramassage_gratuit: true, livraison_gratuite: true, is_active: true, statut: 'actif' },
  { id: 'sub3', article: 'Abonnement Prestige', service: 'abonnement', prix: 60000, description: '100 vêtements max | Validité 30 jours | 4 ramassages max | Ramassage et livraison gratuits', categorie: 'abonnement', nombre_vetements: 100, duree_jours: 30, ramassage: true, nombre_ramassages: 4, ramassage_gratuit: true, livraison_gratuite: true, is_active: true, statut: 'actif' },
  { id: 'sub4', article: 'Abonnement VIP', service: 'abonnement', prix: 100000, description: '200 vêtements max | Validité 30 jours | 4 ramassages max | Ramassage et livraison gratuits', categorie: 'abonnement', nombre_vetements: 200, duree_jours: 30, ramassage: true, nombre_ramassages: 4, ramassage_gratuit: true, livraison_gratuite: true, is_active: true, statut: 'actif' },
